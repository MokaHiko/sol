...
pub fn init(proj_type: ProjectionType, opts: Options) Camera {
    var camera = Camera{
...
pub fn proj(self: Camera) math.Mat4 {
    return self._proj;
}

pub fn viewProj(self: Camera) math.Mat4 {
    return self.proj().mul(self.view());
}

pub fn setOrthogonal(self: *Camera, size: f32, z_near: f32, z_far: f32) void {
